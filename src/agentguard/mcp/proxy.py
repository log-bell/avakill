...
AgentGuard policy before being forwarded.
"""
...
from agentguard.core.exceptions import RateLimitExceeded
...
class MCPProxyServer:
    ...
    async def shutdown(self) -> None:
        ...
        logger.info("AgentGuard MCP proxy shut down.")
                ...
                "content": [
                    {
                        "type": "text",
                        "text": (
                            f"\u26d4 AgentGuard blocked this tool call: "
