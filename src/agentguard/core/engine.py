"""Core Guard class -- the main entry point for AgentGuard."""
...
from agentguard.core.exceptions import PolicyViolation, RateLimitExceeded
from agentguard.core.models import AuditEvent, Decision, PolicyConfig, ToolCall
...
class Guard:
    """The central AgentGuard controller.
    ...
    def __init__(
        ...
        Args:
            policy: A filesystem path (str/Path) to a YAML policy file,
                ...
                to auto-detect agentguard.yaml in cwd.
