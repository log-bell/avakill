"""AgentGuard validate command - validate a policy file."""
...
from agentguard.core.exceptions import ConfigError
from agentguard.core.policy import PolicyEngine


@click.command()
@click.argument("policy_file", default="agentguard.yaml")
