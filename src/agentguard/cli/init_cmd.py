"""AgentGuard init command - initialize a new policy file."""
...
def init(template: str | None, output: str) -> None:
    """Initialize a new AgentGuard policy file."""
    console = Console()
    ...
    console.print()
    console.print(Panel(body, title="AgentGuard Initialized", border_style="green", padding=(1, 2)))
    ...
    if detected:
        ...
        if len(detected) > 1:
            ...
            console.print("[dim]Run [bold]agentguard init --help[/bold] for more options.[/dim]")

    console.print()
    console.print("[bold]Next steps:[/bold]")
    console.print("  1. Review and customise [cyan]agentguard.yaml[/cyan]")
    console.print("  2. Add AgentGuard to your agent code (see snippet above)")
    console.print("  3. Run [cyan]agentguard dashboard[/cyan] to monitor in real-time")
    console.print("  4. Run [cyan]agentguard validate[/cyan] to check your policy")
    console.print()
