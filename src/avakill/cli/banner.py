...
def print_banner() -> None:
    ...
    hint = Text()
    hint.append("run ")
    hint.append("avakill guide", style="bold")
    hint.append(" to get started   \u00b7   ")
    hint.append("avakill --help", style="bold")
    hint.append(" for all commands")
    con.print(hint, style="#6B7280", justify="center")
    con.print()
